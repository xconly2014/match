...
class AopClient {
    ...
    protected function curl($url, $postFields = null) {
        $log_msg = 'Req: ' . json_encode($postFields) . "\r\n";
        ...
        $log_msg .= 'Resp: ' . $reponse . "\r\n";
        \app\lib\Log::pay($log_msg, $url);
    ...
    */
    public function pageExecute($request,$httpmethod = "POST") {
        $totalParams = $this->totalParams($request, false);
    ...
    public function totalParams($request, $checkEmpty = true) {
        $this->setupCharsets($request);
