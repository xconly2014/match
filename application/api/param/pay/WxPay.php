...
class WxPay extends Validate
{
    ...
    public $doc = [
        ...
        'description' => '使用MD5类型签名，微信支付文档：https://pay.weixin.qq.com/wiki/doc/api/app/app.php?chapter=4_3<br /> 请自行设置appid 和 mch_id',
    ];
}